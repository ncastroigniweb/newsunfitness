...
/* harmony import */ var _awesome_cordova_plugins_camera_ngx__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @awesome-cordova-plugins/camera/ngx */ "vaRf");
...
let ProfilePage = class ProfilePage {
    constructor(camera, dataService, plt, navCtrl, firebase, authService) {
        this.camera = camera;
    ...
    ionViewWillEnter() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.since = moment__WEBPACK_IMPORTED_MODULE_7__(yield this.firebase.getCreationTime()).fromNow(true);
