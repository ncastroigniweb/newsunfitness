(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-posts-posts-module"], {
    ...
    function xoP(module, __webpack_exports__, __webpack_require__) {
      ...
      var PostsPageRoutingModule = /*#__PURE__*/_createClass(function PostsPageRoutingModule() {
    ...
    function FvZU(module, __webpack_exports__, __webpack_require__) {
      ...
      var PostsPage = /*#__PURE__*/function () {
        function PostsPage(plt, dataService) {
              ...
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    this.dataService.getDataPosts().subscribe(function (resp) {
                      _this.featuredItems = resp.filter(function (e, index) {
                        return e.post_featured === '1';
                      });
    ...
    function XxUk(module, __webpack_exports__, __webpack_require__) {
      ...
      var PostsPageModule = /*#__PURE__*/_createClass(function PostsPageModule() {
